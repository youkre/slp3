...
生成过程首先计算在已有上下文 <span class="math">\(w_{<i}\)</span> 下，下一个词元 <span class="math">\(w_i\)</span> 的概率 <span class="math">\(P(w_i \mid w_{<i})\)</span>，再从该概率分布中采样出一个词元。
...
并观察哪些词元 <span class="math">\(w\)</span> 具有高概率。
